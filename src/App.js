      ...
      <div>
        ...
        <div className='container d-flex justify-content-center mt-4'> {/* d-flex is a built in Bootstrap class to make your div a flex container. mt-4 stands for margin top 4 */}
          <Routes>
            ...
            <Route path='/create_post' element={<CreatePost user={this.state.user}/>} />
            <Route path='/update_post/:postId' element={<UpdatePost user={this.state.user} />} />
            <Route path='/create_product' element={<CreateProduct user={this.state.user} />} />
            <Route path='/update_product/:productId' element={<UpdateProduct user={this.state.user} />} />
          </Routes>
        </div>
      </div>
    )
